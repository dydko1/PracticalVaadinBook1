...
public class AppLoginForm extends Composite<Component> {
    ...
    protected Component initContent() {
        ...
        loginOverlay.setTitle("Chapter 78");
        loginOverlay.setDescription("Navigate and routing");
        loginOverlay.setOpened(true);

        loginOverlay.addLoginListener(e -> Notification.show("Use admin/admin or user/user"));
        ...
        System.out.println("App login view called");
