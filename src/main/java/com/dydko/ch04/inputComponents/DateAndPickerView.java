...
@Route("ch04/datepicker")
public class DateAndPickerView extends Composite<Component> {
    @Override
    protected Component initContent() {
        DatePicker datePicker = new DatePicker("Enter a memorable date",
                LocalDate.now(),
                e ->showMessage(e.getValue())
        );
    ...
    private void showMessage(LocalDate date) {
        Notification.show(date + " is great!");
    }
}
