package com.dydko.ch05.manualBinding;
...
public class ProductManagementView extends Composite<Component> {
    ...
    protected Component initContent(){
        updateList();
        return new VerticalLayout(new Button("New product", VaadinIcon.PLUG.create(),
                e->showProductForm(new Product())), productsLayout);
    }
